...
СТАТУС: Устаревший скрипт. Задача выполнена.
  Все уроки переведены на формат ссылок по названию урока:
    «В уроке «Confusion Matrix» мы видели...»
  Числовые ссылки «Из урока N мы знаем...» в курсе больше не встречаются.
  Текущий запуск: 0 совпадений, 0 изменений.

  Паттерн REF_PATTERN = r'Из урока \d+ мы знаем...' не соответствует
  новому формату title-based ссылок.
